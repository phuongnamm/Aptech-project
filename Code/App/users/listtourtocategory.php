                    ...
                    foreach ($list as $value) {
                        echo "
                            <div class='col-lg-4 col-md-6 col-sm-12'>
                                <div class='container-tour_list mb-5'>
                                            ...
                                            <a href='./booktour.php?id=$value->CategoryTourID' class='d-inline-block tour-item'>
                                                <div class='container-tour_item col-lg-4 col-md-6 col-sm-12'>
                                                    <div class='box-img' style='width:75%'>
                                                        <img src='$value->AvatarTour' alt='' style='width:350px;height: 240px;border-radius: 10px;'>
                                                    </div>
                                                    <div class='a box-text text-center bg-light' style='width:300px;height: 370px;overflow:hidden;'>
                                                        ...
                                                        <h5 class='post-title is-large text-dark'>$value->TourName</h5>
                                                        <div class='price_tour' style='color: #3da4ff'>$value->TourPrice</div>
                                                        <div class='date_go text-dark'><i class='bi bi-clock' style='color: #3da4ff'></i>$value->Day Day</div>
                                                        <p class='from_the_blog_excerpt'>$value->Leadcontent</p>
                                                    </div>
                                                </div>
                                            </a>
                                    </button>

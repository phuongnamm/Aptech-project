                ...
                <div class="container text-center">
                    <div class="row" style="margin-bottom:100px;">
                        <?php foreach ($arr as $value): ?>
                                            ...
                                            <a href='./booktour.php?id=<?php echo $value->TourID ?>' class='d-inline-block tour-item'>
                                                <div class='container-tour_item col-lg-4 col-md-6 col-sm-12 mt-5 mb-5'>
                                                    <div class='box-img' style='width:75%'>
                                                        <img src='<?php echo $value->AvatarTour?>' alt='' style='width:350px;height: 240px;border-radius: 10px;'>
                                                    </div>
                                                    <div class='a box-text text-center bg-light' style='width:300px;height: 400px;overflow:hidden'>
                                                        ...
                                                        <p class='from_the_blog_excerpt '><?php echo $value->Leadcontent?></p>
                                                    </div>
                                                </div>
                                            </a> 
                                    </button>
                            ...
                            <?php endforeach ?>
                        <a href='./listtourtocategory.php?id=<?php echo $value->CategoryTourID ?>' class="btn btn-warning" style="width: 100px; margin: 0 auto;">See More</a>
                    </div>
                </div>
                <?php endforeach ?>
        </div>

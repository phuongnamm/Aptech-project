            ...
            <div class="container ">
                <div class="container-service text-center d-flex">
                    <div class="content-service" style="margin-bottom: 100px;">
                        <div class="text-center title-tourname"><span class="title-service">OUR SERVICE</span></div>
                        <?php
                        $s = new Service();
                        $listService = $s->getListService();
                        foreach ($listService as $value) {
                            echo "  <div class='service-food text-start'>
                            <h3 class='text-center mt-5'>$value->serviceName</h3>
                            <div class='row'>
                                <div class='col-lg-9 col-md-6 col-sm-12'>
                                    <ul>
                                        <li><span style='font-size:20px;color:#0d6efd;margin-right: 10px'>Detail:</span>$value->description</li>
                                        <li><span style='font-size:20px;color:#0d6efd;margin-right: 10px'>Price:</span>$value->price USD</li>
                                        <li><span style='font-size:20px;color:#0d6efd;margin-right: 10px'>VAT:</span>$value->vAT %</li>
                                        <li><span style='font-size:20px;color:#0d6efd;margin-right: 10px'>Sale:</span>$value->sale %</li>
                                    </ul>
                                </div>
                                <div class='col-lg-3 col-md-6 col-sm-12'>
                                    <img src='$value->avatarService' alt='' style='width: 300px;border-radius: 10px;margin-left: 30px;'>
                                </div>
                            </div>
                        </div>";
                        }
